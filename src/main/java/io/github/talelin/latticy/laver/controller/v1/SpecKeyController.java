...
public class SpecKeyController {
    ...
    @GetMapping("/{id}")
    public SpecKeyDO get(@PathVariable(value = "id") @Positive(message = "{id.positive}") Integer id) {
        return null;
    }

    @GetMapping("/by/spu/{id}")
    public List<SpecKeyDO> getBySpuId(@PathVariable(value = "id") @Positive(message = "{id.positive}") Integer id){
